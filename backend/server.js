...
mongoose
  .connect(
    "mongodb+srv://arshdeepkaur64:Database@cluster0.xwulojc.mongodb.net/products?retryWrites=true&w=majority"
  )
  .then((result) => {
    server.listen(port, () => {
...
server.post(/register", async( request, response) => {
  ...
  saveUser ? response.send("User is created") : response.send("Failed to create User");
